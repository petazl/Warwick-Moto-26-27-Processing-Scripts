...
[pks1, locs1] = findpeaks(phase1_voltage_1000, 'MinPeakHeight', 0);
[pks2, locs2] = findpeaks(phase1_voltage_2000, 'MinPeakHeight', 0);
[pks3, locs3] = findpeaks(phase1_voltage_3000, 'MinPeakHeight', 0);
[pks4, locs4] = findpeaks(phase1_voltage_4000, 'MinPeakHeight', 0);
[pks5, locs5] = findpeaks(phase1_voltage_5000, 'MinPeakHeight', 0);
[pks6, locs6] = findpeaks(phase1_voltage_6000, 'MinPeakHeight', 0);

% Calculate the average of those peak values
V_rms_1000 = mean(pks)/sqrt(2);
V_rms_2000 = mean(pks)/sqrt(2);
V_rms_3000 = mean(pks)/sqrt(2);
V_rms_4000 = mean(pks)/sqrt(2);
